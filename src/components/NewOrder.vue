  ...
  <div>
    <b-navbar toggleable="md" type="dark" variant="primary" sticky="true">
      ...
      <b-collapse is-nav id="nav_collapse">
        <b-button pressed="true" variant="primary">Yeni Siparişler</b-button>
        <b-button v-on:click="route('OnWayOrder')" variant="primary">Yoldaki Siparişler</b-button>
        <b-button v-on:click="route('DeliveredOrder')" variant="primary">Teslim Edilen Siparişler</b-button>
...
export default {
  ...
  data () {
    return {
      ...
      isplay: false // uygulama ilk açıldığında bildirim sesinin gelmemesi için
    }
  },
  components: {
    OrderCard
  ...
  beforeUpdate: function () {
    if (this.isplay) {
      // this.playSound('https://firebasestorage.googleapis.com/v0/b/kolaysiparis-53c7b.appspot.com/o/sesler%2Fping.mp3?alt=media&token=b635c573-c58b-4871-b979-2bb67284c3d4')
    }
    alert(this.isplay)
  },
  updated: function () {
  ...
  firebase: {
    siparisler: {
      source: db.ref('SiparislerDb').orderByChild('yeniSiparisZaman'),
      cancelCallback (err) {
        console.error(err)
      }
    },
